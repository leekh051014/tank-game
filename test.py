...
icon = pygame.image.load("C:/Users/lee/Desktop/pygame work space/.vscode/venv/ic.jpg")
...
def tank(x, y, turPos):
    ...
    tankImg = pygame.image.load("C:/Users/lee/Desktop/pygame work space/.vscode/venv/tank1-nocannon.png")  # 새 이미지 경로로 변경
    tankImg = pygame.transform.scale(tankImg, (tankWidth, tankHeight))
   
    turretImg = pygame.image.load("C:/Users/lee/Desktop/pygame work space/.vscode/venv/tank1-cannon.png")  # 캐논 이미지 경로로 변경
    turretImg = pygame.transform.rotate(turretImg, 360 - turPos * 360 / 8)  # 캐논 각도에 맞게 회전
    turretImg = pygame.transform.scale(turretImg, (tankWidth, tankHeight))

    gameDisplay.blit(tankImg, (x - tankWidth/2, y - tankHeight/2))  # 탱크 이미지를 화면에 그림
    gameDisplay.blit(turretImg, (x - tankWidth/2, y - tankHeight/2))  # 캐논 이미지를 화면에 그림
    ...
    pygame.draw.line(gameDisplay, yellow, (x, y), possibleTurrets[turPos], turretWidth)
...
def enemy_tank(x, y, turPos):
    x = int(x)
    y = int(y)
    enemyTankImg = pygame.image.load("C:/Users/lee/Desktop/pygame work space/.vscode/venv/tank2-nocannon.png")  # 적 탱크 이미지 경로로 변경
    enemyTankImg = pygame.transform.scale(enemyTankImg, (tankWidth, tankHeight))

    enemyTurretImg = pygame.image.load("C:/Users/lee/Desktop/pygame work space/.vscode/venv/tank2-cannon.png")  # 적 캐논 이미지 경로로 변경
    enemyTurretImg = pygame.transform.rotate(enemyTurretImg, 360 - turPos * 360 / 8)  # 캐논 각도에 맞게 회전
    enemyTurretImg = pygame.transform.scale(enemyTurretImg, (tankWidth, tankHeight))

    gameDisplay.blit(enemyTankImg, (x - tankWidth/2, y - tankHeight/2))  # 적 탱크 이미지를 화면에 그림
    gameDisplay.blit(enemyTurretImg, (x - tankWidth/2, y - tankHeight/2))  # 적 캐논 이미지를 화면에 그림
...
def game_controls():
    ...
    while gcont:
        ...
        message_to_screen(" D: hight Power , A: lower Power  ", wheat, 140)
        message_to_screen("P: setting", wheat, 90)
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Created by : LKH", wheat, 280)
